...
import { heroTopImage, heroBottomImage } from "../../assets";
    ...
    <div className="mx-auto w-full max-w-7xl">
      <aside className="relative mx-2 overflow-hidden rounded-lg text-black sm:mx-16 sm:py-16">
        ...
        <div className="absolute inset-0 h-full w-full pt-12 sm:my-20 sm:pt-1 ">
          <img className="w-96" src={heroTopImage} alt="image1" />
        </div>
      </aside>

      <div className="grid  place-items-center sm:mt-20">
        <img className="w-48 sm:w-96" src={heroBottomImage} alt="image2" />
      </div>
